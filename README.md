 plataforma-dePlataforma gestao-escolarde Gestão Escolar
📖 Descrição
...
▶️ Como Executar o Projeto
    ...
    Executar script SQL atualizado (pasta /database)

    Configurar conexão com o banco no arquivo /config/database.php

    Rodar servidor local:

php -S localhost:8000

    Acessar a API via Postman ou navegador: http://localhost:8000/list/alunos
